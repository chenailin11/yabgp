...
class TestExtCommunity(unittest.TestCase):
    ...
    def test_parse_rt0(self):
        ...
        self.assertEqual(['{}:{}'.format(bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_RT_0], '100:12')],
                         ext_community)
    ...
    def test_parse_rt1(self):
        ...
        self.assertEqual(['{}:{}'.format(bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_RT_1], '10.10.10.10:12')],
                         ext_community)
    ...
    def test_parse_rt2(self):
        ...
        self.assertEqual(['{}:{}'.format(bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_RT_2], '65537:12')],
                         ext_community)
    ...
    def test_parse_ro0(self):
        ...
        self.assertEqual(['{}:{}'.format(bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_RO_0], '100:12')],
                         ext_community)
    ...
    def test_parse_ro1(self):
        ...
        self.assertEqual(['{}:{}'.format(bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_RO_1], '10.10.10.10:12')],
                         ext_community)
    ...
    def test_parse_ro2(self):
        ...
        self.assertEqual(['{}:{}'.format(bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_RO_2], '65537:12')],
                         ext_community)
    ...
    def test_parse_invalid_length(self):
        # invalid length
        self.assertRaises(excep.UpdateMessageError, ExtCommunity.parse, b'\x00\x00\x02\x00\x64\x00\x00\x00\x0c')
        try:
    ...
    def test_parse_construct_flowspec_redirect_vrf(self):
        ...
        expected_value = ['{}:{}'.format(bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_REDIRECT_VRF], '4837:100')]
        self.assertEqual(b'\xc0\x10\x08\x80\x08\x12\xe5\x00\x00\x00d', ExtCommunity.construct(value=community_list))
        self.assertEqual(expected_value, ExtCommunity.parse(value=community_hex))

    def test_parse_construct_flowspec_redirect_nh(self):
        community_list = [[bgp_cons.BGP_EXT_REDIRECT_NH, '0.0.0.0', 0]]
        expected_value = ['{}:{}:{}'.format(bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_REDIRECT_NH], '0.0.0.0', 0)]
        self.assertEqual(b'\xc0\x10\x08\x08\x00\x00\x00\x00\x00\x00\x00', ExtCommunity.construct(value=community_list))
        self.assertEqual(expected_value, ExtCommunity.parse(value=b'\x08\x00\x00\x00\x00\x00\x00\x00'))

    def test_parse_construct_tarffic_rate(self):
        community_list = [[bgp_cons.BGP_EXT_TRA_RATE, "100:6250000"]]
        expected_value = ['{}:{}'.format(bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_TRA_RATE], '100:6250000')]
        self.assertEqual(b'\xc0\x10\x08\x80\x06\x00dJ\xbe\xbc ', ExtCommunity.construct(value=community_list))
        self.assertEqual(expected_value, ExtCommunity.parse(value=b'\x80\x06\x00dJ\xbe\xbc '))
    ...
    def test_parse_construct_transitive_opaque_encap(self):
        ...
        expected_value = [f'{bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_ENCAP]}:{8}']
        self.assertEqual(expected_value, ExtCommunity.parse(community_hex))
    ...
    def test_parse_construct_es_import(self):
        ...
        expected_value = [
            '{}:{}'.format(bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_EVPN_ES_IMPORT], '00-11-22-33-44-55')
        ]
        self.assertEqual(expected_value, ExtCommunity.parse(community_hex))
        self.assertEqual(community_hex, ExtCommunity.construct(community_list)[3:])
    ...
    def test_parse_construct_els_label(self):
        ...
        expected_value = [f'{bgp_cons.BGP_EXT_COM_STR_DICT[bgp_cons.BGP_EXT_COM_EVPN_ESI_MPLS_LABEL]}:{1}:{20}']
        self.assertEqual(community_hex, ExtCommunity.construct(community_list)[3:])
        self.assertEqual(expected_value, ExtCommunity.parse(community_hex))
    ...
    def test_parse_construct_evpn_route_mac(self):
        ...
        expected_value = ['{}:{}'.format(bgp_cons.BGP_EXT_COM_STR_DICT[1539], '74-A0-2F-DE-FE-FB')]
        self.assertEqual(expected_value, ExtCommunity.parse(community_hex))
